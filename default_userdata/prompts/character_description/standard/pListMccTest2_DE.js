...
function personalityDescription(char) {
  ...
  if (typeof char.boldness === "number") {
    if (char.boldness >= 70) traits.push("äußerst mutig");
    else if (char.boldness >= 40) traits.push("mutig");
    else if (char.boldness >= 20) traits.push("etwas mutig");
    else if (char.boldness <= -70) traits.push("äußerst feige");
    else if (char.boldness <= -40) traits.push("feige");
    else if (char.boldness <= -20) traits.push("etwas feige");
  }
  
  if (typeof char.compassion === "number") {
    if (char.compassion >= 70) traits.push("äußerst mitfühlend");
    else if (char.compassion >= 40) traits.push("mitfühlend");
    else if (char.compassion >= 20) traits.push("etwas mitfühlend");
    else if (char.compassion <= -70) traits.push("äußerst grausam");
    else if (char.compassion <= -40) traits.push("grausam");
    else if (char.compassion <= -20) traits.push("etwas grausam");
  }
  
  if (typeof char.energy === "number") {
    if (char.energy >= 70) traits.push("äußerst fleißig");
    else if (char.energy >= 40) traits.push("fleißig");
    else if (char.energy >= 20) traits.push("etwas fleißig");
    else if (char.energy <= -70) traits.push("äußerst faul");
    else if (char.energy <= -40) traits.push("faul");
    else if (char.energy <= -20) traits.push("etwas faul");
  }
  
  if (typeof char.greed === "number") {
    if (char.greed >= 70) traits.push("äußerst gierig");
    else if (char.greed >= 40) traits.push("gierig");
    else if (char.greed >= 20) traits.push("etwas gierig");
    else if (char.greed <= -70) traits.push("äußerst großzügig");
    else if (char.greed <= -40) traits.push("großzügig");
    else if (char.greed <= -20) traits.push("etwas großzügig");
  }
  
  if (typeof char.honor === "number") {
    if (char.honor >= 70) traits.push("äußerst ehrenhaft");
    else if (char.honor >= 40) traits.push("ehrenhaft");
    else if (char.honor >= 20) traits.push("etwas ehrenhaft");
    else if (char.honor <= -70) traits.push("äußerst hinterhältig");
    else if (char.honor <= -40) traits.push("hinterhältig");
    else if (char.honor <= -20) traits.push("etwas hinterhältig");
  }
  
  if (typeof char.rationality === "number") {
    if (char.rationality >= 70) traits.push("äußerst rational");
    else if (char.rationality >= 40) traits.push("rational");
    else if (char.rationality >= 20) traits.push("etwas rational");
    else if (char.rationality <= -70) traits.push("äußerst emotional");
    else if (char.rationality <= -40) traits.push("emotional");
    else if (char.rationality <= -20) traits.push("etwas emotional");
  }
  
  if (typeof char.sociability === "number") {
    if (char.sociability >= 70) traits.push("äußerst gesellig");
    else if (char.sociability >= 40) traits.push("gesellig");
    else if (char.sociability >= 20) traits.push("etwas gesellig");
    else if (char.sociability <= -70) traits.push("äußerst schüchtern");
    else if (char.sociability <= -40) traits.push("introvertiert");
    else if (char.sociability <= -20) traits.push("etwas schüchtern");
  }
  
  if (typeof char.vengefulness === "number") {
    if (char.vengefulness >= 70) traits.push("äußerst nachtragend");
    else if (char.vengefulness >= 40) traits.push("nachtragend");
    else if (char.vengefulness >= 20) traits.push("etwas nachtragend");
    else if (char.vengefulness <= -70) traits.push("äußerst verzeihend");
    else if (char.vengefulness <= -40) traits.push("verzeihend");
    else if (char.vengefulness <= -20) traits.push("etwas verzeihend");
  }
  
  if (typeof char.zeal === "number") {
    if (char.zeal >= 70) traits.push("äußerst eifrig");
    else if (char.zeal >= 40) traits.push("eifrig");
    else if (char.zeal >= 20) traits.push("etwas eifrig");
    else if (char.zeal <= -70) traits.push("äußerst zynisch");
    else if (char.zeal <= -40) traits.push("zynisch");
    else if (char.zeal <= -20) traits.push("etwas zynisch");
  }
  
  if (traits.length === 0) return null;
  return `Persönlichkeitskern: ${traits.join(", ")}`;
}
